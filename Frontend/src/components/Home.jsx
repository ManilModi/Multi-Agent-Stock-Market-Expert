...
const handleGetStarted = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300">
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Harness the power of 6 specialized AI agents providing real-time analysis, predictions, and comprehensive
              market insights for investors, brokers, and companies. Make smarter decisions with AI-driven intelligence.
            </p>
      ...
      {/* AI Agents Section */}
      <section className="py-16 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-900 dark:to-slate-800 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Meet Our 6 AI Agents</h3>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Each agent specializes in a specific aspect of market analysis, working together to provide comprehensive
              insights
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of traders, investors, and companies already using AI to make smarter financial decisions.
          </p>
